# -*- coding: utf-8 -*-
#
# haralyzer documentation build configuration file, created by
...
latex_documents = [
  ('index', 'haralyzer.tex', u'haralyzer Documentation',
   u'Justin Crown', 'manual'),
]
